...
(1, '請盡快安排訂單#220101574出貨。', 1, 0),
(2, '#220154879訂單已完成撿貨及出貨。', 2, 0),
(3, '庫存商品牛奶貝已向XXX供應商自動補貨，等待XXX供應商確認。', 3, 0),
(4, '收到XXX廠商的鱸魚訂單，請於2022/09/08 10:30前進行訂單確認。', 1, 1),
(5, '訂單#220154666的貨品已送達採購商。', 1, 0);
